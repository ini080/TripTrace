					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-12 pb-5 single">
								<div class="row">
									<div class="img img-single w-100" style="background-image: url(../../../../resources/static/main/images/work-single.jpg);"></div>
									<div class="px-5 mt-4">
										...
										<div class="about-author d-flex p-4">
											<div class="bio mr-5">
												<img src="../../../../resources/static/main/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
											</div>
											<div class="desc">
										...
										<div class="pt-5 mt-5">
											...
											<ul class="comment-list">
												<li class="comment">
													<div class="vcard bio">
														<img src="../../../../resources/static/main/images/person_1.jpg" alt="Image placeholder">
													</div>

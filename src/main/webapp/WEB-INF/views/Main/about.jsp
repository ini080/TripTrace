		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="/Main/About.do">About</a></li>
					...
					<div class="container-fluid px-0">
						<div class="row d-flex">
							<div class="col-md-6 d-flex">
								<div class="img d-flex align-self-stretch align-items-center js-fullheight" style="background-image:url(../../../../resources/static/main/images/about.jpg);">
								</div>
							</div>
								...
								<div class="text px-4 pt-5 pt-md-0 px-md-4 pr-md-5 ftco-animate">
									...
									<div class="team-wrap row mt-4">
										<div class="col-md-4 team">
											<div class="img" style="background-image: url(../../../../resources/static/main/images/team-1.jpg);"></div>
											<h3>John Doe</h3>
											<span>Photographer</span>
										</div>
										<div class="col-md-4 team">
											<div class="img" style="background-image: url(../../../../resources/static/main/images/team-2.jpg);"></div>
											<h3>John Flex</h3>
											<span>Photographer</span>
										</div>
										<div class="col-md-4 team">
											<div class="img" style="background-image: url(../../../../resources/static/main/images/team-3.jpg);"></div>
											<h3>John Flex</h3>
											<span>Photographer</span>
										</div>
									</div>
